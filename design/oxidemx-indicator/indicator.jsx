...
// ─────────────────────────────────────────────────────────────
// GNOME top bar with the OxideMX indicator in place
// ─────────────────────────────────────────────────────────────

const TopBar = ({ device, popupOpen, dropdownOpen, gaming, haptics, radial, contextLabel = "OxideMX" }) => {
  return (
    <div className="jr-topbar">
      ...
      <div className="jr-topbar-right">
        ...
        <div
          className={`jr-tray-btn jr-oxidemx-indicator ${popupOpen ? "is-active" : ""}`}
