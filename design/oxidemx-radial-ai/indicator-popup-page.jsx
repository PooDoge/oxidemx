...
// the JuhRadial daemon (not by GJS), so all of this lives in the
  ...
  return (
    <JRAppShell activeNavId="indicator" activeDevice={activeDevice}>
      <JRPageHeader
        ...
        sub="Controls what appears when you click the JuhRadial icon in the GNOME top bar. The popup itself is rendered by JuhRadial — not by the GNOME extension — so it shares this app's theming and reacts to everything you change here."
      />
      ...
      <div className="jr-pref-card">
        ...
        <div className="jr-pref-row">
          <div className="jr-pref-body">
            ...
            <div className="jr-pref-sub">Use the paired hostname when JuhRadial can read it; fall back to “Channel 1/2/3” for unnamed hosts.</div>
          </div>
