...
// ─────────────────────────────────────────────────────────────
// Devices page inside the JuhRadial config app
// ─────────────────────────────────────────────────────────────
...
const DevicesPage = ({ activeId = "mx4", devices = DEVICES }) => {
  ...
  return (
    <JRAppShell activeNavId="devices" activeDevice={active}>
      <JRPageHeader
        title="Devices"
        sub="Pair, switch, and manage every mouse JuhRadial knows about. The active device receives radial overlays, haptic events, and button remaps; everything else is held in inventory."
      />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <div style={{ flex: 1 }}>
            ...
            <div className="jr-device-card-meta">
              Shows a battery glyph in the GNOME top bar; click to open the JuhRadial popup. Configure icons in the extension preferences, popup in the <em style={{ color: "var(--jr-accent)", fontStyle: "normal" }}>Indicator Popup</em> tab.
            </div>
          </div>
