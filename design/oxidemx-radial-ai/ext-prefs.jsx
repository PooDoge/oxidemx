...
// clicks the cog next to "JuhRadial" in the GNOME Extensions app.
//
// Per spec: ONLY icon-display options. The popup itself is owned
// by the JuhRadial daemon and configured in the main app's
  ...
  return (
    <div className="jr-adw">
      ...
      <div className="jr-adw-titlebar">
        <div className="jr-adw-title">JuhRadial Indicator</div>
      ...
      <div className="jr-adw-body">
        ...
        <div className="jr-adw-card">
          <div className="jr-adw-row">
            <div className="jr-adw-row-body">
              ...
              <div className="jr-adw-row-sub">Pick what JuhRadial draws in the panel — the percentage, the battery glyph, or both.</div>
            </div>
        ...
        <div className="jr-adw-card">
          <div className="jr-adw-row">
            ...
            <button className="adw-combo">
              {clickBehavior === "popup"    && "Open JuhRadial popup"}
              {clickBehavior === "settings" && "Open JuhRadial Settings"}
        ...
        <div className="jr-adw-card">
          <div className="jr-adw-row">
            <div className="jr-adw-row-body">
              <div className="jr-adw-row-label">JuhRadial Indicator</div>
              <div className="jr-adw-row-sub">v0.4.2 · GNOME 45+ · GPL-3.0 · Reports battery from the JuhRadial daemon via D-Bus.</div>
            </div>
