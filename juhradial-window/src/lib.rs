//! Window-shell helpers for JuhRadial's iced-rendered surfaces.
//!
//! Two modules:
...
//!   * [`cursor_helper`] — async client for the `juhradial-cursor`
//!     GNOME shell extension's `org.juhradial.CursorHelper` D-Bus
