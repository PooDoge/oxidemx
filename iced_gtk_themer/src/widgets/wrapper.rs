...
impl<M: 'static> Borrow<dyn Widget<M, iced::Theme, iced::Renderer>> for RcElementWrapper<M> {
    fn borrow(&self) -> &(dyn Widget<M, iced::Theme, iced::Renderer> + 'static) {
        self
    }
}

impl<M> Widget<M, iced::Theme, iced::Renderer> for RcElementWrapper<M> {
    ...
    ) -> Option<iced::advanced::overlay::Element<'a, M, iced::Theme, iced::Renderer>> {
