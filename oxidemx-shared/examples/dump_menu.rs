...
//! oxidemx-shared end-to-end:
//!
//!   * AppConfig load from `~/.config/oxidemx/config.json`
...
//!
//! Usage:
//!   cargo run -q -p oxidemx-shared --example dump_menu              # main menu
//!   cargo run -q -p oxidemx-shared --example dump_menu firefox      # menu for the firefox window class

use oxidemx_shared::{ProfileResolver, Theme};
...
fn main() {
    ...
    println!(
        ...
        oxidemx_shared::enumerate_applications().len()
    );
}
