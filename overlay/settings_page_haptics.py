...
class HapticsPage(Gtk.ScrolledWindow):
    ...
    def __init__(self):
        ...
        enable_row = SettingRow(_('Enable Haptic Feedback'), _('Feel vibrations when using the radial menu'))
        ...
        event_settings = [
            ...
            ('slice_change', _('Slice Hover'), _('Pattern when hovering over different slices')),
        ...
        apply_all_row = SettingRow(_('Apply to All'), _('Set all events to the same pattern'))
