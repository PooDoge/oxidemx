...
class SettingsPage(Gtk.ScrolledWindow):
    ...
    def __init__(self):
        ...
        theme_row = SettingRow(_('Theme'), _('Choose color theme for radial menu and settings'))
        ...
        blur_row = SettingRow(_('Blur Effect'), _('Enable background blur for radial menu'))
        ...
        startup_row = SettingRow(_('Start at Login'), _('Launch JuhRadial MX when you log in'))
        ...
        reset_row = SettingRow(_('Restore Defaults'), _('Reset all settings to factory defaults'))
...
"""
    ...
    def _on_reset_clicked(self, button):
        ...
        dialog = Adw.AlertDialog(
            ...
            body=_("All settings have been restored to defaults. Please restart JuhRadial MX for changes to take effect.")
        )
