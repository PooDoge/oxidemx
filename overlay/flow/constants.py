...
# Set high (8000) to only trigger on very deliberate fast slams, not normal use.
EDGE_VELOCITY_INSTANT_PX_PER_S = 8000

# Indicator zone: only trigger edge detection within this many pixels of the
# screen center (where the indicator bar sits). Restricts to the indicator
# area to prevent accidental handoffs at corners or non-indicator parts.
EDGE_INDICATOR_ZONE_PX = 350
