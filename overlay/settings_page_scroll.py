...
class ScrollPage(Gtk.ScrolledWindow):
    ...
    def __init__(self):
        ...
        accel_row = SettingRow(_('Acceleration Profile'), _('How pointer speed scales with movement'))
        ...
        # Note
        note = Gtk.Label()
        note.set_markup(f'<span size="small" color="{COLORS["subtext0"]}">' + _('Applies DPI, SmartShift, and scroll settings via logiops (requires sudo)') + '</span>')
        ...
        smartshift_desc = Gtk.Label(label=_('Auto-switch to free-spin when scrolling fast, return to ratchet when slow'))
        ...
        # Scroll direction
        direction_row = SettingRow(_('Natural Scrolling'), _('Scroll content in the direction of finger movement'))
        ...
        smooth_row = SettingRow(_('High-Resolution Scroll'), _('More scroll events for smoother, faster scrolling'))
        ...
        scroll_speed_row = SettingRow(_('Scroll Speed'), _('Lines scrolled per wheel notch'))
        ...
        thumb_speed_row = SettingRow(_('Scroll Speed'), _('Horizontal scroll sensitivity'))
        ...
        thumb_invert_row = SettingRow(_('Invert Direction'), _('Reverse thumb wheel scroll direction'))
